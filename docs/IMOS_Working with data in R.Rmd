...
subtitle: Working with ATF data in R
output:
  html_document:
...
# Animal tracking data and the National Animal Acoustic Telemetry Database

The IMOS Animal Tracking Facility maintains a [National Animal Acoustic Telemetry Database](https://animaltracking.aodn.org.au). This database has been designed to allow researchers to store, share and access animal detection data collected using Acoustic Telemetry. Detection data that stored on the database can be be downloaded via the [webapp](https://animaltracking.aodn.org.au). This brief vignette highlights steps to quickly access and explore the data you store on the database using R.


![ ](Images/Data download workflow/Step0.png)

<br><br>

## Downloading your data

In this vignette, we will be working with data from three Tiger Sharks (*Galeocerdo cuvier*) that were monitored around Heron and One Tree Islands. These tiger sharks were monitored over three years as part of a larger study examining the ecology and movement patterns of reef predators . In this session we will use these data to calculate three types of home ranges for tiger sharks around Heron and One Tree Island.
